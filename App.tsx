...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#030712] text-slate-100 font-sans overflow-hidden">
      <header className="flex-none bg-[#030712] border-b border-white/5 px-6 py-4 flex items-center justify-between shadow-xl z-50">
        <a 
        ...
        <div className="hidden md:block">
           <span className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.2em]">Strategy & Intelligence Radar</span>
        </div>
      </header>
